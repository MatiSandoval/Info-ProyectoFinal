...
class Calificacion(models.Model):
    articulo = models.ForeignKey('articulo.Articulo', on_delete=models.CASCADE, null=True, related_name= 'calificacion')
    usuario = models.ForeignKey(settings.AUTH_USER_MODEL, on_delete=models.CASCADE, blank=True, null=True, related_name='calificacion')
